<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="faq.aspx.cs" Inherits="FirstHome.faq" %>
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li>
                                <a href="portfolio-1-col.aspx">1 Column Portfolio</a>
                            </li>
                            <li>
                                <a href="portfolio-2-col.aspx">2 Column Portfolio</a>
                            </li>
                            <li>
                                <a href="portfolio-3-col.aspx">3 Column Portfolio</a>
                            </li>
                            <li>
                                <a href="portfolio-4-col.aspx">4 Column Portfolio</a>
                            </li>
                            <li>
                                <a href="portfolio-item.aspx">Single Portfolio Item</a>
                            </li>
                        </ul>
                    </li>
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li>
                                <a href="blog-home-1.aspx">Blog Home 1</a>
                            </li>
                            <li>
                                <a href="blog-home-2.aspx">Blog Home 2</a>
                            </li>
                            <li>
                                <a href="blog-post.aspx">Blog Post</a>
                            </li>
                        </ul>
                    </li>
                    <li class="dropdown active">
                        ...
                        <ul class="dropdown-menu">
                            <li>
                                <a href="full-width.aspx">Full Width Page</a>
                            </li>
                            <li>
                                <a href="sidebar.aspx">Sidebar Page</a>
                            </li>
                            <li class="active">
                                <a href="faq.aspx">FAQ</a>
                            </li>
                            <li>
                                <a href="404.aspx">404</a>
                            </li>
                            <li>
                                <a href="pricing.aspx">Pricing Table</a>
                            </li>
                        </ul>
                    </li>
                </ul>
