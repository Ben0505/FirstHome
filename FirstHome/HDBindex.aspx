...
<body>
    ...
    <div class="container">
            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h4><i class="fa fa-fw fa-upload"></i> Quick Upload</h4> </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <h2 class="page-header">Uploaded BTO</h2> </div>
            <div class="col-md-4 col-sm-6">
                <a href="singleFlat.aspx"> <img class="img-responsive img-portfolio img-hover" src="pics/house1.jpg" alt=""> </a>
            </div>
            <div class="col-md-4 col-sm-6">
                <a href="singleFlat.aspx"> <img class="img-responsive img-portfolio img-hover" src="pics/house2.jpg" alt=""> </a>
            </div>
            <div class="col-md-4 col-sm-6">
                <a href="singleFlat.aspx"> <img class="img-responsive img-portfolio img-hover" src="pics/house3.jpg" alt=""> </a>
            </div>
            <div class="col-md-4 col-sm-6">
                <a href="singleFlat.aspx"> <img class="img-responsive img-portfolio img-hover" src="pics/house4.jpg" alt=""> </a>
            </div>
            <div class="col-md-4 col-sm-6">
                <a href="singleFlat.aspx"> <img class="img-responsive img-portfolio img-hover" src="pics/house5.jpg" alt=""> </a>
            </div>
            <div class="col-md-4 col-sm-6">
                <a href="singleFlat.aspx"> <img class="img-responsive img-portfolio img-hover" src="pics/house6.jpg" alt=""> </a>
            </div>
        </div>
        <!-- /.row -->
