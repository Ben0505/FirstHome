<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="favHouse.aspx.cs"  %>
...
<body>
  ...
  <div class="view view-seen">
    <a href="#"> <img class="media-object" src="http://placehold.it/361x250" alt="..."></a>
    <div class="mask">
      <h2>Empire State</h2>
      ...
      <a href="#" class="info">Read More</a>
                        ...
                        <li>
                            <a href="#"> <img class="media-object" src="http://placehold.it/361x250" alt="..."></a> </li>
                        <li>
                            <a href="#"> <img class="media-object" src="http://placehold.it/361x250" alt="..."></a> </li>
                        <li>
                            <a href="#"> <img class="media-object" src="http://placehold.it/361x250" alt="..."></a> </li>
                ...
                <div class="panel panel-default">
                    <div class="media">
                        <div class="media-left media-middle">
                            <a href="#"> <img class="media-object" src="http://placehold.it/350x250" alt="..."> </a>
                        </div>
                        <div class="media-body">
                            <h4 class="media-heading">123 Kovan Road</h4> Flat Type: 5-Room
                            <br/>Unit number: #08-41
                            <br/>Postal Code: 201123
                            <br/>
                            <br/>Price: $300.000
                            <br/>Size: 1,471 sqft </div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    <div class="media">
                        ...
                        <div class="media-body">
                            <h4 class="media-heading">254 Sambawang Street</h4> Flat Type: 5-Room
                            <br/>Unit number: #08-41
            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    <div class="media">
                        ...
                        <div class="media-body">
                            <h4 class="media-heading">321 Jalan Kululut</h4> Flat Type: 5-Room
                            <br/>Unit number: #08-41
            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    <div class="media">
                        ...
                        <div class="media-body">
                            <h4 class="media-heading">Blk 150 Lorong 11 Bidadari,</h4> Flat Type: 3-Room
                            <br/>Unit number: #08-41
                            <br/>Postal Code: 201123
                            <br/>
                            <br/>Price: $400.000
            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    <div class="media">
                        ...
                        <div class="media-body">
                            <h4 class="media-heading">6 Jalan Rindu</h4> Flat Type: 5-Room
                            <br/>Unit number: #08-41
                            <br/>Postal Code: 201123
                            <br/>
                            <br/>Price: $300.000
